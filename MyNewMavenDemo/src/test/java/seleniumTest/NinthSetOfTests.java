package seleniumTest;
	...
	public class NinthSetOfTests {
		
	public static WebDriver driver;
		
		@Test(enabled = true)
		public static void currentlyUsingQuickBooks() throws InterruptedException, IOException {

			String browser = Modules.getInputDataFromPropertiesFile(
					"NinthSetProperties.xls", "BROWSER");
			String url = Modules.getInputDataFromPropertiesFile(
					"NinthSetProperties.xls", "URL");

			driver = Modules.launchBrowser(browser, url);
			Thread.sleep(10000);
			
			String expString = Modules.getInputDataFromPropertiesFile(
					"NinthSetProperties.xls", "EXPDATA1");
			String actualText = driver.getTitle();
			Thread.sleep(2000);
			String passFail = Modules.verifyText(actualText, expString);
			System.out.println(passFail + "test case passed");
			
			String username = Modules.getInputDataFromPropertiesFile("NinthSetProperties.xls", "UNAME");
			String password = Modules.getInputDataFromPropertiesFile("NinthSetProperties.xls", "PASS");
			...
			String expString4 = Modules.getInputDataFromPropertiesFile(
					"NinthSetProperties.xls", "EXPDATA4");
			...
			driver.findElement(By.xpath(".//*[@id='industrysearchcombofield-1025-inputEl']")).sendKeys("Accounting and Bookkeeping Services");
			Thread.sleep(2000);
			...
			*/
			...
			//clicking move your data
			//.//*[@id='conversionLink']
			
			//clicking check box want to convert data
			//.//*[@id='conversionCheckbox-inputEl']
			
			//clicking buy now button
			
			//clicking continue button
			//.//*[@id='simplebutton-1036']
